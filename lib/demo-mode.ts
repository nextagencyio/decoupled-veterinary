...
import providersData from '@/data/mock/team.json'
import petResourcesData from '@/data/mock/resources.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'team.json': providersData,
  'resources.json': petResourcesData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetPetResources') || query.includes('nodePetResources')) {
